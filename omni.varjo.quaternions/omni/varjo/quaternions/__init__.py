...
class OmniVarjoQuaternionsExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omni.varjo.quaternions] OmniVarjoQuaternionsExtension startup", flush=True)

    def on_shutdown(self):
        print("[omni.varjo.quaternions] OmniVarjoQuaternionsExtension shutdown", flush=True)
